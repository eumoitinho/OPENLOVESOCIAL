...
export function ProfileView({ profile, setProfile }: ProfileViewProps) {
  ...
  return (
    <div className="flex-1 ml-72 mr-80 bg-gray-50/30 dark:bg-gray-900/30 min-h-screen">
      <div className="max-w-4xl mx-auto py-6">
        ...
        <Card className="border-0 shadow-sm bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl overflow-hidden mb-6">
          <div className="relative">
            {/* Cover Photo */}
            <div className="h-48 bg-gradient-to-r from-pink-500 via-rose-500 to-purple-500 relative">
              <Button
                variant="ghost"
                size="icon"
            ...
            <div className="relative px-6 pb-6">
                ...
                <div className="flex gap-2 mt-4 sm:mt-0">
                  <Dialog open={isEditing} onOpenChange={setIsEditing}>
                    <DialogTrigger asChild>
                      <Button
                        variant="outline"
                        className="border-pink-300 dark:border-pink-700 text-pink-600 dark:text-pink-400 bg-transparent"
                      >
              ...
              {/* Stats */}
              <div className="grid grid-cols-4 gap-4 mt-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
