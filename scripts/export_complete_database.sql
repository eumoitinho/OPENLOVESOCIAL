-- Script para exportar COMPLETAMENTE a estrutura do banco de dados
...
SELECT 
    '-- RECREATE TABLE: ' || schemaname || '.' || relname as comment,
    'DROP TABLE IF EXISTS ' || schemaname || '.' || relname || ' CASCADE;' as drop_statement
FROM pg_tables 
WHERE schemaname IN ('public', 'auth')
