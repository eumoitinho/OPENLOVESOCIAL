-- =====================================================
-- SCRIPT 036: CORREÇÃO FINAL COMPLETA DO BANCO DE DADOS
-- =====================================================
-- Data: 2025-01-27
-- Descrição: Corrigir todas as inconsistências e garantir compatibilidade total
-- =====================================================
...
-- Mostrar estrutura atual da tabela posts
SELECT 
    'Estrutura atual da tabela posts:' as info,
    column_name,
    data_type,
    is_nullable
...
-- =====================================================
-- 4. VERIFICAR E CORRIGIR TABELA LIKES
-- =====================================================
...
-- =====================================================
-- 5. VERIFICAR E CORRIGIR TABELA COMMENTS
-- =====================================================
...
-- =====================================================
-- 6. VERIFICAR E CORRIGIR TABELA FOLLOWS
-- =====================================================
...
-- =====================================================
-- 7. VERIFICAR E CORRIGIR TABELA CONVERSATIONS
-- =====================================================
...
-- =====================================================
-- 8. VERIFICAR E CORRIGIR TABELA CONVERSATION_PARTICIPANTS
-- =====================================================
...
-- =====================================================
-- 9. VERIFICAR E CORRIGIR TABELA MESSAGES
-- =====================================================
...
-- =====================================================
-- 10. VERIFICAR E CORRIGIR TABELA MESSAGE_REACTIONS
-- =====================================================
...
BEGIN
    ...
    ELSE
        -- Verificar se a coluna reaction existe (não reaction_type)
        IF NOT EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'message_reactions' AND column_name = 'reaction') THEN
            -- Se não existe reaction, mas existe reaction_type, renomear
            IF EXISTS (SELECT FROM information_schema.columns WHERE table_name = 'message_reactions' AND column_name = 'reaction_type') THEN
                ALTER TABLE message_reactions RENAME COLUMN reaction_type TO reaction;
            ELSE
                -- Adicionar coluna reaction
                ALTER TABLE message_reactions ADD COLUMN reaction VARCHAR(50) NOT NULL DEFAULT 'heart' CHECK (reaction IN ('heart', 'thumbsup', 'laugh', 'sad', 'angry'));
            END IF;
        END IF;
...
-- =====================================================
-- 11. VERIFICAR E CORRIGIR TABELA EVENTS
-- =====================================================
...
-- =====================================================
-- 12. VERIFICAR E CORRIGIR TABELA EVENT_PARTICIPANTS
-- =====================================================
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'posts' AND policyname = 'Users can update their own posts') THEN
        CREATE POLICY "Users can update their own posts" ON posts
            FOR UPDATE USING (auth.uid() = user_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'posts' AND policyname = 'Users can delete their own posts') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'saved_posts' AND policyname = 'Users can view their own saved posts') THEN
        CREATE POLICY "Users can view their own saved posts" ON saved_posts
            FOR SELECT USING (auth.uid() = user_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'saved_posts' AND policyname = 'Users can insert their own saved posts') THEN
        CREATE POLICY "Users can insert their own saved posts" ON saved_posts
            FOR INSERT WITH CHECK (auth.uid() = user_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'saved_posts' AND policyname = 'Users can delete their own saved posts') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'likes' AND policyname = 'Users can view all likes') THEN
        CREATE POLICY "Users can view all likes" ON likes
            FOR SELECT USING (true);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'likes' AND policyname = 'Users can insert their own likes') THEN
        CREATE POLICY "Users can insert their own likes" ON likes
            FOR INSERT WITH CHECK (auth.uid() = user_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'likes' AND policyname = 'Users can delete their own likes') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'comments' AND policyname = 'Users can view all comments') THEN
        CREATE POLICY "Users can view all comments" ON comments
            FOR SELECT USING (true);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'comments' AND policyname = 'Users can insert their own comments') THEN
        CREATE POLICY "Users can insert their own comments" ON comments
            FOR INSERT WITH CHECK (auth.uid() = user_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'comments' AND policyname = 'Users can update their own comments') THEN
        CREATE POLICY "Users can update their own comments" ON comments
            FOR UPDATE USING (auth.uid() = user_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'comments' AND policyname = 'Users can delete their own comments') THEN
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'follows' AND policyname = 'Users can view all follows') THEN
        CREATE POLICY "Users can view all follows" ON follows
            FOR SELECT USING (true);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'follows' AND policyname = 'Users can insert their own follows') THEN
        CREATE POLICY "Users can insert their own follows" ON follows
            FOR INSERT WITH CHECK (auth.uid() = follower_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE table_name = 'follows' AND policyname = 'Users can delete their own follows') THEN
...
SELECT 
    'Estrutura final da tabela posts:' as info,
    column_name,
    data_type,
    is_nullable
FROM information_schema.columns 
...
-- Verificar estrutura da tabela message_reactions
SELECT 
    'Estrutura da tabela message_reactions:' as info,
    column_name,
    data_type,
    is_nullable
FROM information_schema.columns 
